                ...
                return (
                  <button key={f.id} onClick={() => setSelected(f)} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 13.5, fontWeight: 600, color: 'var(--dark)' }}>{f.name}</div>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5 }}>
                    {selected.services.map(s => (
                      <span key={s} style={{ fontSize: 11, padding: '3px 9px', borderRadius: 99, background: 'var(--maroon-pale)', color: 'var(--maroon)', fontWeight: 600 }}>{s}</span>
                    ))}
                  </div>
                </div>
